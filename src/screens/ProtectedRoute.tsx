...
import Text from '../components/Text'; // Assuming a custom Text component is used
...
const styles = StyleSheet.create({
  loadingContainer: {
    // Mimics the 'min-h-screen flex items-center justify-center' from the web code
    flex: 1,
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: '#fff', // Assuming a white background for the screen
  },
  loadingText: {
    marginTop: 10,
